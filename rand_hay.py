...
class GenHstacks:
    def __init__(self, n, dSNR, sigma, NeedleSize, HstackSize, NeedleType):
        self.n = n
    ...
    def build_hstack(self):
        ...
        self.save(haystack.astype(np.int8), info)
...
def main():
    ...
    GenHstacks(args.n, args.dSNR, args.sigma, args.NeedleSize, args.HstackSize, args.NeedleType).build_hstack()
